...
function legacyMigrationView(d){
  ...
  if(!review){queueMicrotask(loadLegacyMigrationReview);return `${header("LEGACY MIGRATION","Grouped provenance review","Legacy өгөгдлийг import хийхгүйгээр deterministic review case болгон бэлтгэж байна.")}<section class="admin-panel"><p>Review case ачаалж байна...</p></section>`}
  ...
  return `${header("LEGACY MIGRATION","Safe batch review","Actual import, employee/master update, workflow history үүсгэх үйлдэл энэ дэлгэцэд байхгүй.")}
