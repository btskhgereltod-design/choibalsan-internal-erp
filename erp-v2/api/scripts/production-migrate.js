...
async function grantRuntimeRole() {
  ...
  try {
    ...
    await client.query(`REVOKE UPDATE,DELETE,TRUNCATE ON audit_logs,platform_audit_logs,security_audit_events,platform_support_access_events,data_lifecycle_events,document_versions,document_lifecycle_events,integration_execution_events,document_links,data_quality_measurements,smart_import_events,data_quality_finding_events,report_schedule_events,report_schedule_command_receipts,work_order_events,work_order_approvals,work_order_safety_reviews,work_order_scope_dispositions,work_order_participant_events,operational_incident_work_orders,operational_incident_command_receipts,operational_object_events,operational_object_specifications,operational_object_lamp_groups,operational_object_supply_points,operational_object_camera_points,operational_object_camera_devices,network_route_revisions,network_node_route_links,network_route_events,network_node_events,network_route_import_batches,network_route_import_candidates,network_route_import_reviews,workflow_transition_events,workflow_assignment_events,workflow_decision_events,workflow_comment_events,workflow_command_receipts,workflow_notification_outbox,workflow_notification_delivery_events,correspondence_events,correspondence_delivery_events,complaint_case_events,complaint_delivery_events,complaint_hr_handoff_events,hr_transfer_case_events,hr_discipline_case_events,archive_events,archive_commission_decisions,archive_disposal_acts,domain_command_receipts,legacy_provenance_decisions,legacy_review_group_members,legacy_review_group_decisions,legacy_review_batch_commands,legacy_canonical_import_runs,legacy_canonical_import_mappings,legacy_canonical_import_events,ai_interview_answers,ai_recommendation_feedback,organization_evidence_sources,organization_evidence_findings,organization_capability_proposals,organization_capability_reviews,smart_import_dataset_sheets,smart_import_dataset_targets,smart_import_dataset_sheet_reviews,connector_connection_events,market_audit_events FROM ${role}`);
    await client.query(`REVOKE DELETE,TRUNCATE ON network_routes,network_nodes FROM ${role}`);
